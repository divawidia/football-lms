...
class AdminUpdatedNotification extends Notification
{
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'data' => "Admin {$this->superAdmin->user->firstName} {$this->superAdmin->user->lastName} has updated admin {$this->targetAdmin->user->firstName} {$this->targetAdmin->user->lastName} account. Please review the changes if necessary!",
