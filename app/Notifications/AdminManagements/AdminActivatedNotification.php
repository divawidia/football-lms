...
class AdminActivatedNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'data' => "Admin {$this->superAdmin->user->firstName} {$this->superAdmin->user->lastName} has activated admin {$this->targetAdmin->user->firstName} {$this->targetAdmin->user->lastName} account. Please review the changes if necessary!",
