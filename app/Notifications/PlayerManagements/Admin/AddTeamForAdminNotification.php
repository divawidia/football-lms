...
class AddTeamForAdminNotification extends Notification implements ShouldQueue
{
    ...
    {
        return [
            'title' => "player have been added to {$this->team->teamName}",
            'data' => "Admin {$this->user->firstName} {$this->user->lastName} has been added player {$this->player->user->firstName} {$this->player->user->lastName} to the {$this->team->teamName}",
