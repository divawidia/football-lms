...
class PlayerDeletedForAdminNotification extends Notification
{
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'data' => "Admin {$this->loggedUser->firstName} {$this->loggedUser->lastName} has deleted a new player {$this->player->user->firstName} {$this->player->user->lastName}. Please review the changes if necessary!",
