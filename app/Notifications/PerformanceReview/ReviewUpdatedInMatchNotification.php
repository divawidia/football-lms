...
class ReviewUpdatedInMatchNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'data' => "'Your performance review in the {$this->matchTeams()} match session have been updated by coach {$this->coach->user->firstName} {$this->coach->user->lastName}.",
