...
class TrainingLessonCreatedForAdmin extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'title' => 'Training Video Lesson Created',
            'data' => "A new training video lesson : {$this->lesson->lessonTitle} in {$this->trainingCourse->trainingTitle} training course has been successfully created by admin ".getUserFullName($this->createdBy).". Please review the created training video lesson!",
