...
class TrainingLessonPublishedForAdmin extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'title' => 'Training Video Lesson Published',
            'data' =>"The training video lesson : '{$this->lesson->lessonTitle}' in {$this->trainingCourse->trainingTitle} training course status has been set to published by admin ".getUserFullName($this->createdBy).". Please review the published training video lesson!",
