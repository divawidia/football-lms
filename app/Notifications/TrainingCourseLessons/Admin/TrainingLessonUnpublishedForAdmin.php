...
class TrainingLessonUnpublishedForAdmin extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'title' => 'Training Video Lesson Unpublished',
            'data' =>"The training video lesson : '{$this->lesson->lessonTitle}' in {$this->trainingCourse->trainingTitle} training course status has been set to unpublished by admin ".getUserFullName($this->createdBy).". Please review the unpublished training video lesson!",
