...
class TrainingCoursePublished extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'data' =>"The '{$this->trainingCourse->trainingTitle}' training course status has been published by admin ".getUserFullName($this->user).". Please review the updated course!",
