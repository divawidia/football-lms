...
class MatchUpdatedForPlayerNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line("A new match schedule for {$this->matchTeams()} has been created." )
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'data' => "A New match schedule for {$this->matchTeams()} scheduled at ".convertToDatetime($this->match->startDatetime).". Please review the schedule and prepare accordingly!",
