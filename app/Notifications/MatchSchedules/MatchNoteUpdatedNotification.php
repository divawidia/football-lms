...
class MatchNoteUpdatedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'title' => "Match session Note Updated",
            'data' => "'A note for {$this->matchTeams()} match session has been updated. Please check the note if needed!'",
