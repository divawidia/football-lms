...
class MatchScheduleUpdatedForPlayerCoach extends Notification implements ShouldQueue
{
    use Queueable;
...
//        return ['database'];
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line("The match session for your team {$this->matchSchedule->teams[0]->teamName} at ".convertToDatetime($this->matchSchedule->startDatetime)." {$this->status}.")
    ...
    {
        return [
            'data' =>'The match session for '.$this->matchSchedule->teams[0]->teamName.' Vs. '.$this->matchSchedule->teams[1]->teamName.' at '.convertToDatetime($this->matchSchedule->startDatetime).' '.$this->status.'. Please check the schedule for details!',
