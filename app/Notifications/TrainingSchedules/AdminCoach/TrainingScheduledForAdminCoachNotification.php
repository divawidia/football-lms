...
class TrainingScheduledForAdminCoachNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line("Training session for {$this->team->teamName} has been set to scheduled by {$this->loggedUserRole} {$this->loggedUser->firstName} {$this->loggedUser->lastName}." )
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'data' => "{$this->loggedUserRole} {$this->loggedUser->firstName} {$this->loggedUser->lastName} has set the training session to scheduled for {$this->team->teamName} scheduled at ".convertToDatetime($this->training->startDatetime).". Please check the training schedule for more information!",
