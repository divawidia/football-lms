...
class TrainingCreatedForAdminCoachNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'data' => "{$this->loggedUserRole} {$this->loggedUser->firstName} {$this->loggedUser->lastName} has created a New training schedule for {$this->team->teamName} scheduled at ".convertToDatetime($this->training->startDatetime).". Please review the schedule and prepare accordingly!",
