...
class TrainingUpdatedForAdminCoachNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject("Training schedule Updated")
            ->greeting("Hello {$notifiable->firstName} {$notifiable->lastName}!")
            ->line("Training schedule for {$this->team->teamName} has been updated by {$this->loggedUserRole} {$this->loggedUser->firstName} {$this->loggedUser->lastName}." )
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'data' => "{$this->loggedUserRole} {$this->loggedUser->firstName} {$this->loggedUser->lastName} has updated training schedule for {$this->team->teamName} scheduled at ".convertToDatetime($this->training->startDatetime).". Please review the schedule and prepare accordingly!",
