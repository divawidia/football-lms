...
class TrainingCanceledForPlayerNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject("Training Session Canceled")
            ->greeting("Hello {$notifiable->firstName} {$notifiable->lastName}!")
            ->line("training schedule for {$this->team->teamName} has been canceled." )
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'data' => "Training schedule for {$this->team->teamName} scheduled at ".convertToDatetime($this->training->startDatetime)." has been canceled!",
