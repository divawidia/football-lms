...
class TrainingsScheduledForPlayerNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line("training session for {$this->team->teamName} has been set to scheduled." )
    ...
    {
        return [
            'title' => "Training Schedule Scheduled",
            'data' => "Training session for {$this->team->teamName} scheduled at ".convertToDatetime($this->training->startDatetime)." has been set to scheduled. Please check the training schedule for more information!",
