<div class="modal fade" id="createNewTeamModal" tabindex="-1"
     aria-labelledby="createNewTeamModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="" method="post" enctype="multipart/form-data" id="formCreateNewTeam">
                @csrf

                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Create new academy team</h5>
...
@push('addon-script')
    <script type="module">
        ...
        $(document).ready(function () {
            showModal('#addNewTeam', '#createNewTeamModal')
