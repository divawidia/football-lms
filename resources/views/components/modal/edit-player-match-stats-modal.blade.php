...
<x-modal-form-update-processing formId="#formPlayerMatchStats"
                                ...
                                :routeUpdate="route('match-schedules.update-player-match-stats', ['schedule' => $eventSchedule->id, 'player' => ':id'])"
    ...
    <script>
        $(document).ready(function (){
            ...
            $('body').on('click', '.edit-player-stats', function (e) {
                ...
                $.ajax({
                    url: "{{ route('match-schedules.show-player-match-stats', ['schedule' => $eventSchedule->id, 'player' => ":id"]) }}".replace(':id', id),
                    type: 'GET',
