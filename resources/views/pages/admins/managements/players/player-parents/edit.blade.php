    ...
    @section('content')
        ...
        <div class="container page__container page-section">
            <div class="list-group">
                <form action="{{ route('player-parents.update', ['player'=>$player->id,'parent'=>$parent->id]) }}" method="post">
                    @method('PUT')
                    @csrf
                    <div class="list-group-item d-flex justify-content-end">
                        <a class="btn btn-secondary mx-2" href="{{ route('player-managements.show', $player->id) }}"><span class="material-icons mr-2">close</span> Cancel</a>
