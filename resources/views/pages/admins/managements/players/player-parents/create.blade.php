...
@section('title')
    Create Player's Parent/Guardian
@endsection
@section('page-title')
    @yield('title')
@endsection
                ...
                <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                    ...
                    <ol class="breadcrumb p-0 m-0">
                        ...
                        <li class="breadcrumb-item"><a
                                    href="{{ route('player-managements.show', $user->id) }}">{{ $fullname }}</a></li>
        ...
        <div class="list-group">
            <form action="{{ route('player-parents.store', $user->id) }}" method="post">
                ...
                <div class="list-group-item d-flex justify-content-end">
                    <a class="btn btn-secondary mx-2" href="{{ route('player-managements.show', $user->id) }}"><span
