...
@section('content')
    <div class="pt-32pt">
        <div class="container page__container d-flex flex-column">
            ...
            <ol class="breadcrumb p-0 m-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('opponentTeam-managements.index') }}">Teams Management</a>
                </li>
                <li class="breadcrumb-item"><a
                            href="{{ route('opponentTeam-managements.show', $team->id) }}">{{ $team->teamName }}</a>
                </li>
    ...
    <div class="container page__container page-section">
        <div class="list-group">
            <form action="{{ route('opponentTeam-managements.update', ['team' => $team]) }}" method="post"
