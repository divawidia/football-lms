            ...
            <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                    ...
                    <ol class="breadcrumb p-0 m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('coach-managements.index') }}">Coach
                                Management</a></li>
        ...
        <div class="list-group">
            <form action="{{ route('coach-managements.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="list-group-item d-flex justify-content-end">
                    <a class="btn btn-secondary mx-2" href="{{ route('coach-managements.index') }}"><span
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                           ...
                                           placeholder="Input player's hire date ...">
                                    @error('hireDate')
                                    <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <small class="text-danger">*</small>
                                    <select class="form-control form-select @error('certificationLevel') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-select @error('specialization') is-invalid @enderror"
                                        ...
                                        @foreach($specializations AS $specialization)
                                            <option value="{{ $specialization->id }}" @selected(old('specialization') == $specialization->id)>{{ $specialization->name }}</option>
                                        @endforeach
                                    </select>
