    ...
    <div class="container page__container page-section">
        ...
        <div class="page-separator">
            ...
            <a href="" id="addTeamScorer" class="btn btn-primary btn-sm ml-auto"><span
                    class="material-icons mr-2">add</span> Filter</a>
        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4 text-center">
                                    <h2 class="mb-0">{{ $latestMatch->teams[0]->pivot->teamScore }}
                                        - {{ $latestMatch->teams[1]->pivot->teamScore }}</h2>
                                </div>
                                <div
                            ...
                            <div class="row justify-content-center mt-3">
                                ...
                                <div class="mr-2">
                                    ...
                                    {{ date('h:i A', strtotime($latestMatch->startTime)) }}
                                    - {{ date('h:i A', strtotime($latestMatch->endTime)) }}
                                </div>
                                <div>
