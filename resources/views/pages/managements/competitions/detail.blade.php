    ...
    <div class="page-section bg-primary">
        <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-md-left">
            ...
            <div class="flex ml-md-4 mb-3 mb-md-0">
                ...
                <p class="lead text-white-50">{{ $competition->type }} ~ @if($competition->isInternal == 1)
                        Internal
                    @else
                        External
                    @endif Competition</p>
            ...
            @if(isAllAdmin())
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="{{ route('competition-managements.edit', $competition->hash) }}"><span
    ...
    <div class="container page__container page-section">
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="overview-tab" role="tabpanel">
                ...
                <div class="row">
                    @include('components.cards.stats-card', ['title' => 'Total Teams', 'data'=>$overviewStats['totalTeams'], 'dataThisMonth'=>null])
                    @include('components.cards.stats-card', ['title' => 'Total Match', 'data'=>$overviewStats['totalMatch'], 'dataThisMonth'=>null])
                    @include('components.cards.stats-card', ['title' => "Total Wins", 'data'=>$overviewStats['ourTeamsWins'], 'dataThisMonth'=>null])
                    @include('components.cards.stats-card', ['title' => "Total Draws", 'data'=>$overviewStats['ourTeamsDraws'], 'dataThisMonth'=>null])
                    @include('components.cards.stats-card', ['title' => "Total Losses", 'data'=>$overviewStats['ourTeamsLosses'], 'dataThisMonth'=>null])
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ml-auto p-2 text-muted">@if($competition->userId)
            ...
            @if($competition->type == 'league')
                <div class="tab-pane fade" id="standing-tab" role="tabpanel">
                    <div class="page-separator">
                        ...
                        @if(isAllAdmin())
                            <x-buttons.link-button size="sm" margin="ml-auto" href="#" icon="add" text="Add Team"
                                                   id="add-team-btn"/>
                        @endif
                    </div>
                    <div class="card">
